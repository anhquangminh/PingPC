...
namespace PingCommandReport
{
    public partial class Main : Form
    {
        ...
        private void OnExited(object sender, EventArgs e)
        {
            ...
            Console.WriteLine("KET QUA : "+process.StartInfo.FileName);
        }
        ...
        private void Main_Load(object sender, System.ComponentModel.CancelEventArgs e)
        {
        ...
        public void getinforSave()
        {
            ...
            tbb04office.Text = ini.IniReadValue("b04", "office");
            tbb04line.Text = ini.IniReadValue("b04", "line");
            textBox13.Text = ini.IniReadValue("b04", "name");
            textBox12.Text = ini.IniReadValue("b04", "id");

            tbb05office.Text = ini.IniReadValue("b05", "office");
            tbb05line.Text = ini.IniReadValue("b05", "line");
            textBox15.Text = ini.IniReadValue("b05", "name");
            textBox14.Text = ini.IniReadValue("b05", "id");

            tbb06office.Text = ini.IniReadValue("b06", "office");
            tbb06line.Text = ini.IniReadValue("b06", "line");
            textBox17.Text = ini.IniReadValue("b06", "name");
            textBox16.Text = ini.IniReadValue("b05", "id");
            ...
            if (arraylistping.Length > 0)
            {
                ...
                for (int i = 0; i < arraylistping.Length; i++)
                {
                    if (PingHost(arraylistping[i].ToString()))
                    {
                        ...
                        string date2 = "2020/02/03 13:46:44";
        ...
        public string[] getlistiprangefromdb(string iprange)
        {
            ...
            using (OracleConnection con = new OracleConnection(strdbisc))
            {
                ...
                {
                    MessageBox.Show("The database is unavailable."+ex);
                }
            }
        ...
        public void checkallipstation()
        {
                ...
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            Thread Thd_Analysis = new Thread(() => Analysispinghostoffice(threadcout, listapscanner, strarray[i - 1], "B03", textBox10.Text.ToString(), textBox11.Text.ToString()));
                            Thd_Analysis.Start();
                        }
                ...
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostline(threadcout, listapscanner, strarray[i - 1], "B03", textBox10.Text.ToString(), textBox11.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            */
            ...
            //B04
            if (tbb04office.Text.ToString() != "")
            {
                var strarray = tbb04office.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length - 1; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostoffice(threadcout, listapscanner, strarray[i], "B04", textBox12.Text.ToString(), textBox13.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            if (tbb04line.Text.ToString() != "")
            {
                var strarray = tbb04line.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length -1 ; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostline(threadcout, listapscanner, strarray[i], "B04", textBox12.Text.ToString(), textBox13.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            //B05
            if (tbb05office.Text.ToString() != "")
            {
                var strarray = tbb05office.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length - 1; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostoffice(threadcout, listapscanner, strarray[i], "B05", textBox14.Text.ToString(), textBox15.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            if (tbb05line.Text.ToString() != "")
            {
                var strarray = tbb05line.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length -1 ; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostline(threadcout, listapscanner, strarray[i], "B05", textBox14.Text.ToString(), textBox15.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            //B06
            if (tbb06office.Text.ToString() != "")
            {
                var strarray = tbb06office.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length - 1; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostoffice(threadcout, listapscanner, strarray[i], "B06", textBox16.Text.ToString(), textBox17.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            if (tbb06line.Text.ToString() != "")
            {
                var strarray = tbb06line.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length  -1; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostline(threadcout, listapscanner, strarray[i], "B06", textBox16.Text.ToString(), textBox17.Text.ToString()));
                            Thd_Analysis.Start();
                        }
