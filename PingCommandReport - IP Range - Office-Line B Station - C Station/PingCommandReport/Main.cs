    ...
    public partial class Main : Form
    {
        ...
        public void deletedata()
        {
            ...
            if (result.Equals(DialogResult.OK))
            {
                ...
                string sql_send = "DELETE FROM iprangeisc where datetime > '2020-07-20 00:00' and datetime < '2020-07-20 23:00' and (stationname ='C03' or stationname ='C02')  ";
        ...
        public void getinforSave()
        {
            ...
            tbc02office.Text = ini.IniReadValue("c02", "office");
            tbc02line.Text = ini.IniReadValue("c02", "line");
            textBox21.Text = ini.IniReadValue("c02", "name");
            textBox20.Text = ini.IniReadValue("c02", "id");

            tbc03uioffice.Text = ini.IniReadValue("c03", "office");
            tbc03uiline.Text = ini.IniReadValue("c03", "line");
            textBox27.Text = ini.IniReadValue("c03", "name");
            textBox26.Text = ini.IniReadValue("c03", "id");
        ...
        private void Analysispinghostoffice(int aa, string[] arraylistping, string iprange, string station, string idcard, string name)
        {
            ...
            if (arraylistping.Length > 0)
            {
                string listIpError = "";
                string listIPPingOk = "";
                for (int i = 0; i < arraylistping.Length - 1; i++)
                {
                    if (PingHost(arraylistping[i].ToString()))
                    {
                        ...
                        string date2 = "2020/02/02 13:46:44";
        ...
        public void checkallipstation()
        {
            ...
            //C02
            if (tbc02office.Text.ToString() != "")
            {
                var strarray = tbc02office.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            Thread Thd_Analysis = new Thread(() => Analysispinghostoffice(threadcout, listapscanner, strarray[i - 1], "C02", textBox20.Text.ToString(), textBox21.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            if (tbc02line.Text.ToString() != "")
            {
                var strarray = tbc02line.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostline(threadcout, listapscanner, strarray[i - 1], "C02", textBox20.Text.ToString(), textBox21.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            //C03
            if (tbc03uioffice.Text.ToString() != "")
            {
                var strarray = tbc03uioffice.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostoffice(threadcout, listapscanner, strarray[i - 1], "C03", textBox26.Text.ToString(), textBox27.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            if (tbc03uiline.Text.ToString() != "")
            {
                var strarray = tbc03uiline.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostline(threadcout, listapscanner, strarray[i - 1], "C03", textBox26.Text.ToString(), textBox27.Text.ToString()));
                            Thd_Analysis.Start();
                        }
