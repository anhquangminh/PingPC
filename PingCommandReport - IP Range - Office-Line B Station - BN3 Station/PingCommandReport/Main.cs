...
namespace PingCommandReport
{
    public partial class Main : Form
    {
        ...
        public void getinforSave()
        {
            ...
            tbbn3f1office.Text = ini.IniReadValue("bn31", "office");
            tbbn3f1line.Text = ini.IniReadValue("bn31", "line");
            textBox19.Text = ini.IniReadValue("bn31", "name");
            textBox18.Text = ini.IniReadValue("bn31", "id");

            tbbn3f2office.Text = ini.IniReadValue("bn32", "office");
            tbbn3f2line.Text = ini.IniReadValue("bn32", "line");
            textBox23.Text = ini.IniReadValue("bn32", "name");
            textBox22.Text = ini.IniReadValue("bn32", "id");

            tbbn3f3office.Text = ini.IniReadValue("bn33", "office");
            tbbn3f3line.Text = ini.IniReadValue("bn33", "line");
            textBox25.Text = ini.IniReadValue("bn33", "name");
            textBox24.Text = ini.IniReadValue("bn33", "id");
        ...
        public void checkallipstation()
        {
            ...
            //Bn3 -F1
            if (tbbn3f1office.Text.ToString() != "")
            {
                var strarray = tbbn3f1office.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length - 1; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            Thread Thd_Analysis = new Thread(() => Analysispinghostoffice(threadcout, listapscanner, strarray[i], "BN3-1F", textBox18.Text.ToString(), textBox19.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            if (tbbn3f1line.Text.ToString() != "")
            {
                var strarray = tbbn3f1line.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length - 1 ; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostline(threadcout, listapscanner, strarray[i], "BN3-1F", textBox18.Text.ToString(), textBox19.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            //BN3 -F2
            if (tbbn3f2office.Text.ToString() != "")
            {
                var strarray = tbbn3f2office.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length - 1; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostoffice(threadcout, listapscanner, strarray[i], "BN3-2F", textBox22.Text.ToString(), textBox23.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            if (tbbn3f2line.Text.ToString() != "")
            {
                var strarray = tbbn3f2line.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length - 1; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostline(threadcout, listapscanner, strarray[i], "BN3-2F", textBox22.Text.ToString(), textBox23.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            //BN3 - F3
            if (tbbn3f3office.Text.ToString() != "")
            {
                var strarray = tbbn3f3office.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length - 1; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostoffice(threadcout, listapscanner, strarray[i], "BN3-3F", textBox24.Text.ToString(), textBox25.Text.ToString()));
                            Thd_Analysis.Start();
                        }
            ...
            if (tbbn3f3line.Text.ToString() != "")
            {
                var strarray = tbbn3f3line.Text.ToString().Split(',');
                if (strarray.Length > 0)
                {
                    for (int i = 0; i < strarray.Length - 1; i++)
                    {
                        if (strarray[i] != "")
                        {
                            ...
                            threadcout = threadcout + 1;
                            Thread Thd_Analysis = new Thread(() => Analysispinghostline(threadcout, listapscanner, strarray[i], "BN3-3F", textBox24.Text.ToString(), textBox25.Text.ToString()));
                            Thd_Analysis.Start();
                        }
