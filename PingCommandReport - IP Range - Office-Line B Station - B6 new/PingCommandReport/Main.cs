...
namespace PingCommandReport
{
    public partial class Main : Form
    {
        ...
        {
            string filePath2 = AppDomain.CurrentDomain.BaseDirectory + "\\save-ip-exception.txt"; //1
        ...
        public void getinforSave()
        {
            ...
            textBox17.Text = ini.IniReadValue("b06", "name"); //1
            textBox16.Text = ini.IniReadValue("b06", "id");
